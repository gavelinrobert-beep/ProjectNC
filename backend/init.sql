...
-- ============================================================================
-- Phase 2 Inventory Enhancements - Integrated directly
-- Note: Migration files in backend/migrations/ are for reference only
-- ============================================================================
...
ALTER TABLE inventory ADD COLUMN IF NOT EXISTS dimensions_cm TEXT;
ALTER TABLE inventory ADD COLUMN IF NOT EXISTS special_handling TEXT;
ALTER TABLE inventory ADD COLUMN IF NOT EXISTS customer_info JSONB;
