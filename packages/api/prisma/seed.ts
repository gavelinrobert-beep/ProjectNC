...
async function main() {
  ...
  const quests = [
    ...
    {
      id: 'eyes_in_the_grove',
      name: 'Eyes in the Grove',
      description: 'Scout Thalan wants you to cut down the Grove Stalkers spying on the enclave and report back.',
      level: 2,
      requiredLevel: 1,
      objectivesJson: JSON.stringify([
        {
          id: 'slay_grove_stalkers',
          description: 'Slay Grove Stalkers',
          type: 'KILL',
          targetId: 'grove_stalker',
          required: 3,
        },
      ]),
      experienceReward: 90,
